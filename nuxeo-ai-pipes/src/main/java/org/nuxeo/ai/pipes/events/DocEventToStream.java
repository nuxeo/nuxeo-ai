...
public class DocEventToStream implements Function<Event, Collection<BlobTextFromDocument>> {
    ...
    protected static final List<PropertyNameType> DEFAULT_BLOB_PROPERTIES = Collections.singletonList(new PropertyNameType(FILE_CONTENT, IMAGE_TYPE));

    private static final Log log = LogFactory.getLog(DocEventToStream.class);

    protected final List<PropertyNameType> blobProperties;
     ...
     */
    public DocEventToStream(List<PropertyNameType> blobProperties,
