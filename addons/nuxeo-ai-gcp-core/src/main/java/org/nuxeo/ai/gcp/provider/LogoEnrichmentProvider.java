 ...
 */
public class LogoEnrichmentProvider extends AbstractTagProvider<EntityAnnotation>
        implements EnrichmentCachable, Polygonal {

    private static final Logger log = LogManager.getLogger(LogoEnrichmentProvider.class);
    ...
    protected List<EntityAnnotation> getAnnotationList(AnnotateImageResponse res) {
        return res.getLogoAnnotationsList();
    }
