...
public interface TextractProcessor<T> {
    ...
    /*
     * Turn a block geometry into a normalized AIMetadata.Box Default implementation for backward compatibility
     */
    ...
    /**
     * Gets the normalized confidence from the block Default implementation for backward compatibility
     */
