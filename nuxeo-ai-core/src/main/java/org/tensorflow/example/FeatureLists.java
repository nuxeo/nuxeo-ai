...
org.tensorflow.example.FeatureList defaultValue) {
  ...
  public static final class Builder extends
    ...
    private static final class FeatureListConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.String, org.tensorflow.example.FeatureListOrBuilder, org.tensorflow.example.FeatureList> {
      @java.lang.Override
      public org.tensorflow.example.FeatureList build(org.tensorflow.example.FeatureListOrBuilder val) {
        if (val instanceof org.tensorflow.example.FeatureList) { return (org.tensorflow.example.FeatureList) val; }
        return ((org.tensorflow.example.FeatureList.Builder) val).build();
      }

      @java.lang.Override
      public com.google.protobuf.MapEntry<java.lang.String, org.tensorflow.example.FeatureList> defaultEntry() {
    ...
    private com.google.protobuf.MapFieldBuilder<
        java.lang.String, org.tensorflow.example.FeatureListOrBuilder, org.tensorflow.example.FeatureList, org.tensorflow.example.FeatureList.Builder> featureList_;
    private com.google.protobuf.MapFieldBuilder<java.lang.String, org.tensorflow.example.FeatureListOrBuilder, org.tensorflow.example.FeatureList, org.tensorflow.example.FeatureList.Builder>
        internalGetFeatureList() {
      if (featureList_ == null) {
...
org.tensorflow.example.FeatureList defaultValue) {
      if (key == null) { throw new NullPointerException("map key"); }
      java.util.Map<java.lang.String, org.tensorflow.example.FeatureListOrBuilder> map = internalGetMutableFeatureList().ensureBuilderMap();
    ...
    public Builder putAllFeatureList(
      ...
      for (java.util.Map.Entry<java.lang.String, org.tensorflow.example.FeatureList> e : values.entrySet()) {
     ...
     * <code>map&lt;string, .tensorflow.FeatureList&gt; feature_list = 1;</code>
     */
    public org.tensorflow.example.FeatureList.Builder putFeatureListBuilderIfAbsent(
        java.lang.String key) {
      java.util.Map<java.lang.String, org.tensorflow.example.FeatureListOrBuilder> builderMap = internalGetMutableFeatureList().ensureBuilderMap();
      org.tensorflow.example.FeatureListOrBuilder entry = builderMap.get(key);
      if (entry == null) {
        entry = org.tensorflow.example.FeatureList.newBuilder();
        builderMap.put(key, entry);
      }
      if (entry instanceof org.tensorflow.example.FeatureList) {
        entry = ((org.tensorflow.example.FeatureList) entry).toBuilder();
        builderMap.put(key, entry);
      }
      return (org.tensorflow.example.FeatureList.Builder) entry;
    }
