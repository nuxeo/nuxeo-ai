...
org.tensorflow.example.Feature defaultValue) {
  ...
  public static final class Builder extends
    ...
    private static final class FeatureConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.String, org.tensorflow.example.FeatureOrBuilder, org.tensorflow.example.Feature> {
      @java.lang.Override
      public org.tensorflow.example.Feature build(org.tensorflow.example.FeatureOrBuilder val) {
        if (val instanceof org.tensorflow.example.Feature) { return (org.tensorflow.example.Feature) val; }
        return ((org.tensorflow.example.Feature.Builder) val).build();
      }

      @java.lang.Override
      public com.google.protobuf.MapEntry<java.lang.String, org.tensorflow.example.Feature> defaultEntry() {
    ...
    private com.google.protobuf.MapFieldBuilder<
        java.lang.String, org.tensorflow.example.FeatureOrBuilder, org.tensorflow.example.Feature, org.tensorflow.example.Feature.Builder> feature_;
    private com.google.protobuf.MapFieldBuilder<java.lang.String, org.tensorflow.example.FeatureOrBuilder, org.tensorflow.example.Feature, org.tensorflow.example.Feature.Builder>
        internalGetFeature() {
      if (feature_ == null) {
...
org.tensorflow.example.Feature defaultValue) {
      if (key == null) { throw new NullPointerException("map key"); }
      java.util.Map<java.lang.String, org.tensorflow.example.FeatureOrBuilder> map = internalGetMutableFeature().ensureBuilderMap();
    ...
    public Builder putAllFeature(
      ...
      for (java.util.Map.Entry<java.lang.String, org.tensorflow.example.Feature> e : values.entrySet()) {
     ...
     * <code>map&lt;string, .tensorflow.Feature&gt; feature = 1;</code>
     */
    public org.tensorflow.example.Feature.Builder putFeatureBuilderIfAbsent(
        java.lang.String key) {
      java.util.Map<java.lang.String, org.tensorflow.example.FeatureOrBuilder> builderMap = internalGetMutableFeature().ensureBuilderMap();
      org.tensorflow.example.FeatureOrBuilder entry = builderMap.get(key);
      if (entry == null) {
        entry = org.tensorflow.example.Feature.newBuilder();
        builderMap.put(key, entry);
      }
      if (entry instanceof org.tensorflow.example.Feature) {
        entry = ((org.tensorflow.example.Feature) entry).toBuilder();
        builderMap.put(key, entry);
      }
      return (org.tensorflow.example.Feature.Builder) entry;
    }
