...
package org.nuxeo.ai.tensorflow.ext;
...
/**
 * See https://github.com/tensorflow/ecosystem/blob/master/hadoop/src/main/java/org/tensorflow/hadoop/util/TFRecordWriter.java
 */
public class TensorflowWriter {

    private final DataOutput output;

    public TensorflowWriter(DataOutput output) {
        this.output = output;
    }
